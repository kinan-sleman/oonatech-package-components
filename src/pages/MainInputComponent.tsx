        ...
        <>
            <div className="flex ">
                <MainInput
                    ...
                    error={errorMessage}
                    inputBorder
                    prefix={<div className="border-0 outline-none"
                        contentEditable={false}>+963</div>} 
                />
            </div>
