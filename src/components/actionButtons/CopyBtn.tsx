...
function CopyBtn({ handleCopy }: { handleCopy: any }) {
  ...
  return (
    <button
      ...
      onClick={handleCopy}
      className="w-7 h-7 hover:bg-[#fbffad] transition-all  bg-[#F4F4F4] rounded-[5px] flex items-center justify-center"
    >
      <svg
